...
def get_custom_reward_fn(config, tokenizer, is_validation=False):
    ...
    Args:
        ...
        tokenizer: Tokenizer instance injected into reward kwargs.
        is_validation (bool): Whether this reward function is for validation.
            Injected into reward kwargs so downstream reward functions can
            use a different grader model for validation batches.
    ...
    reward_kwargs['is_validation'] = is_validation
...
def load_reward_manager(config, tokenizer, num_examine, is_validation=False, **reward_kwargs):
    ...
    if is_validation and val_with_default:
        ...
        compute_score = get_custom_reward_fn(config, tokenizer, is_validation=is_validation)
