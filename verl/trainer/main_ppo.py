...
class TaskRunner:
    ...
    def run(self, config):
        ...
        chat_template_path = config.data.get("chat_template_path", None)
        tokenizer = hf_tokenizer(
            local_path, trust_remote_code=trust_remote_code, chat_template_path=chat_template_path
        )
        ...
        val_reward_fn = load_reward_manager(
            config, tokenizer, num_examine=1, is_validation=True,
